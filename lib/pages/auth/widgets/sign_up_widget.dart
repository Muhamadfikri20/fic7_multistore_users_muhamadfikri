  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        Container(
          margin: const EdgeInsets.only(left: Dimensions.marginSizeLarge, right: Dimensions.marginSizeLarge, bottom: Dimensions.marginSizeLarge, top: Dimensions.marginSizeLarge),
        ...
        Center(
          ...
          children: [
            TextButton(
                ...
                child: Text('Skip for Now', style: titilliumRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: ColorResources.getPrimary(context)))),
            Icon(
              Icons.arrow_forward,
              size: 15,
